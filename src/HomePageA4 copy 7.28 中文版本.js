    ...
    <div className="container" ref={containerRef}>
      ...
      <div className="content-container">
        ...
        <div className="bottom-section">
          {/* {[
            ['贷款金额', data.loan_amount, data.financialMetrics.loanAmount.note, loanIcon],
            ['项目估价', data.security_value, data.financialMetrics.propertyValue.potentialValue, projectIcon],
